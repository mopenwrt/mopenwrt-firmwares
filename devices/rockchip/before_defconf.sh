...
sed -i 's,1608,1800,g' package/community/luci-app-cpufreq/root/etc/uci-defaults/cpufreq
sed -i 's,2016,2208,g' package/community/luci-app-cpufreq/root/etc/uci-defaults/cpufreq
sed -i 's,1512,1608,g' package/community/luci-app-cpufreq/root/etc/uci-defaults/cpufreq
...
[ $USE_CLASH == "true" ] && $GITHUB_WORKSPACE/scripts/preset-clash-core.sh armv8
